...
'*                                                                                                          *
'* Descripción: Módulo principal del componente "Sicofin: Fixed Reports".                                   *
'*                                                                                                          *
...
Private Const cnComponentName As String = "Fixed Reports"
...
Public Enum TEnumConstants
  ...
  cnURLFilesPath = 901
  cnDocumentNamePrefix = 902
  cnDocumentExtension = 903
  cnMaxNumberOfDocs = 904
End Enum

Public Const cnBlancosCorte As Long = 76
Public Const cnPageLines As Long = 45

'************************************************************************************************************
'* DECLARACIÓN DE LAS CONSTANTES DE EXCEPCIÓN                                                               *
'************************************************************************************************************
Private Const cnFirstError = 30020
Private Const cnLastError = 30039

Public Enum TEnumErrors
  ErrConstantNotFound = 30020
End Enum
