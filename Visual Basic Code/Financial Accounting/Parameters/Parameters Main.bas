...
'*                                                                                                          *
'* Descripción: Módulo principal del componente "Financial Accounting: Parameters".                         *
'*                                                                                                          *
...
Private Const cnComponentName As String = "Parameters"
...
'************************************************************************************************************
Private Const cnFirstError = 6480
Private Const cnLastError = 6499

Public Enum TEnumErrors
  ErrConstantNotFound = 6480
End Enum
