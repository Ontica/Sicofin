...
'*                                                                                                          *
'* Descripción: Módulo principal del componente "Financial Accounting: Ledger Accounts BS".                 *
'*                                                                                                          *
...
Private Const cnComponentName As String = "Ledger Accounts BS"
...
Public Enum TEnumConstants
  cnLastSystemDate = 900
End Enum

'************************************************************************************************************
'* DECLARACIÓN DE LAS CONSTANTES DE EXCEPCIÓN                                                               *
'************************************************************************************************************
Private Const cnFirstError = 6280
Private Const cnLastError = 6309
