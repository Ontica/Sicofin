...
'*                                                                                                          *
'* Descripción: Módulo principal del componente "Financial Accounting: Transactions Explorer".              *
'*                                                                                                          *
...
Private Const cnComponentName As String = "Transactions Explorer"
...
'************************************************************************************************************
Private Const cnFirstError = 6240
Private Const cnLastError = 6259

Public Enum TEnumErrors
  ErrConstantNotFound = 6240
  ErrUSConstantNotFound = 6241
End Enum
