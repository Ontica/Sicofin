...
'* Módulo     : MMain                                           Patrón  : User Services Main Module         *
'* Fecha      : 31/Diciembre/2001                               Versión : 1.0       Versión patrón: 1.0     *
'*                                                                                                          *
'* Descripción: Módulo principal del componente "Financial Accounting: Ledger Accounts US".                 *
'*                                                                                                          *
...
Private Const cnComponentName As String = "Ledger Accounts US"
...
Public Enum TEnumUSConstant
  cpCboParticipantTypes = 1000
End Enum

'************************************************************************************************************
'* DECLARACIÓN DE LAS CONSTANTES DE EXCEPCIÓN                                                               *
'************************************************************************************************************
Private Const cnFirstError = 6310
Private Const cnLastError = 6329

Public Enum TEnumErrors
  ErrConstantNotFound = 6310
  ErrUSConstantNotFound = 6311
  ErrAccountNotExists = 6312
End Enum
