...
'*                                                                                                          *
'* Descripción: Módulo principal del componente "Standard Account Manager US".                              *
'*                                                                                                          *
...
Private Const cnComponentName As String = "Standard Account Manager US"
...
Public Enum TEnumConstants
  cnApplicationPath = 2000
End Enum


Private Const cnFirstError = 12000
Private Const cnLastError = 12039
