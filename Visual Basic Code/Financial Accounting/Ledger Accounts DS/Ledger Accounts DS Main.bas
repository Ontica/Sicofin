...
'*                                                                                                          *
'* Descripción: Módulo principal del componente "Financial Accounting: Ledger Accounts DS".                 *
'*                                                                                                          *
...
Private Const cnComponentName As String = "Ledger Accounts DS"
...
'************************************************************************************************************
Private Const cnFirstError = 6260
Private Const cnLastError = 6279

Public Enum TEnumErrors
  ErrConstantNotFound = 6260
  ErrDataConstantNotFound = 6261
  ErrDataSourceWithoutPars = 6262
End Enum
