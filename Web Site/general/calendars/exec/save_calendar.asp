<%
  Option Explicit
	...
	gsReturnPage = "../pages/calendar_editor.asp"
  ...
  Sub SaveItem(nItemId)
		...
		Set oRecordset = oCalendar.GetCalendarRS(Session("sAppServer"), CLng(nItemId))
		oRecordset("calendar_name") = Request.Form("txtCalendarName")
		oRecordset("calendar_year")	= Request.Form("cboYears")		
		oCalendar.SaveCalendar Session("sAppServer"), (oRecordset), CLng(nItemId)
		oRecordset.Close
...
<tr>
	<td bgColor="khaki"><b>La información del calendario fue enviada satisfactoriamente.</b></td>
</tr>
<tr><td><br><b>¿Qué desea hacer?</b></td></tr>
<tr>
	<% If CLng(Request.Form("txtItemId")) = 0 Then %>
	<td>
		<a href='<%=gsReturnPage%>'>Agregar otro calendario</a>
	</td>	
	<% Else %>
	<td>
