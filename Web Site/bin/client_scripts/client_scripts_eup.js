...
function tackOptionsWindow(oWindow) {
  ...
  if (arguments[1] != null) {
	...
	if (oWindow.tacked == true) {
		oTackThumb.src = '/banobras/contabilidad/images/tack_white.gif';
		...
		oTackThumb.src = '/banobras/contabilidad/images/tack_down_white.gif';
...
function collapseAll() {
	...
	for (i = 0; i < oTableSections.length; i++) {
		...
		oTableSections[i].all.tags('TR')[0].all.tags('IMG')[0].src = '/banobras/contabilidad/images/expanded.gif';
...
function expandAll() {
	...
	for (i = 0; i < oTableSections.length; i++) {
		oTableSections[i].style.display = 'inline';
		oTableSections[i].value = Math.abs(oTableSections[i].value);
		oTableSections[i].all.tags('TR')[0].all.tags('IMG')[0].src = '/banobras/contabilidad/images/collapsed.gif';
		for (j = 1; j < oTableSections[i].all.tags('TR').length; j++) {
			oTableSections[i].all.tags('TR')[j].style.display = 'inline';
		}
	}	
	return false;
}
...
function outline() {
	...
	if (oObject.src.indexOf('expanded.gif') >= 0) {
		oObject.src = '/banobras/contabilidad/images/collapsed.gif';
		oObject.alt = 'Contraer todo';
		expandAll();		
	} else {
		oObject.src = '/banobras/contabilidad/images/expanded.gif';
...
function selectItems(oSource) {
  ...
  oTableSection.rows[0].all.tags('IMG')[0].src = '/banobras/contabilidad/images/collapsed.gif';
