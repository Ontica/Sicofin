...
function collapseAll() {
	...
	for (i = 0; i < oTableSections.length; i++) {
		...
		oTableSections[i].all.tags('TR')[0].all.tags('IMG')[0].src = '/intranet/contabilidad/images/expanded.gif';
...
function expandAll() {
	...
	for (i = 0; i < oTableSections.length; i++) {
		oTableSections[i].style.display = 'inline';
		oTableSections[i].value = Math.abs(oTableSections[i].value);
		oTableSections[i].all.tags('TR')[0].all.tags('IMG')[0].src = '/intranet/contabilidad/images/collapsed.gif';
		for (j = 1; j < oTableSections[i].all.tags('TR').length; j++) {
