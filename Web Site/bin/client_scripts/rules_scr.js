...
function tackOptionsWindow(oWindow) {
  ...
  if (arguments[1] != null) {
	...
	if (oWindow.tacked == true) {
		oTackThumb.src = '/intranet/contabilidad/images/tack_white.gif';
		...
		oTackThumb.src = '/intranet/contabilidad/images/tack_down_white.gif';
...
function collapseAll() {
	...
	for (i = 0; i < nLength; i++) {
		...
		if ((oRows.length > 0) && (oRows[0].cells[0].all.tags('IMG').length > 0)) {
			oTemp.all.tags('IMG')[0].src = '/intranet/contabilidad/images/expanded.gif';
		}
		if (oTemp.value > 1) {
...
function expandAll() {
	...
	for (i = 0; i < nLength; i++) {		
		...
		if ((oRows.length > 0) && oRows[0].cells[0].all.tags('IMG').length > 0) {
			if (oTemp.id == '') {
				oRows[0].cells[0].all.tags('IMG')[0].src = '/intranet/contabilidad/images/collapsed.gif';
			} else {
				oRows[0].cells[0].all.tags('IMG')[0].src = '/intranet/contabilidad/images/expanded.gif';
			}			
		}
	}
	return false;
...
function outline() {
	...
	if (oObject.src.indexOf('expanded.gif') >= 0) {
		oObject.src = '/intranet/contabilidad/images/collapsed.gif';
		oObject.alt = 'Contraer todo';
		expandAll();	
	} else {
		oObject.src = '/intranet/contabilidad/images/expanded.gif';
...
function outliner() {
	...
	if (oObject.src.indexOf('expanded.gif') >= 0) {
		bExpand = true;
		oObject.src = '/intranet/images/collapsed.gif';
	} else  {
		bExpand = false;
		oObject.src = '/intranet/images/expanded.gif';
	}
...
function selectItems(oSource) {
  ...
  oTableSection.rows[0].all.tags('IMG')[0].src = '/intranet/contabilidad/images/collapsed.gif';
