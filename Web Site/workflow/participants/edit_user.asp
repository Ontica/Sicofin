			...
			<TABLE class=applicationTable>
				...
				<!--<TR>
				  ...
				  <TD>
						...
						<img align=absbottom src='../images/calendar.gif' alt='Despliega el calendario' onclick='showCalendar(document.all.txtBornDate);'>
						&nbsp; (día / mes / año)<br>&nbsp;	
					</TD>
				</TR>
				!-->
				...
				<TR>
				  ...
				  <TD>
						...
						<img align=absbottom src='../images/calendar.gif' alt='Despliega el calendario' onclick='showCalendar(document.all.txtFromDate);'>
						&nbsp; (día / mes / año)<br>&nbsp;
					</TD>
				</TR>
				<% End If %>
