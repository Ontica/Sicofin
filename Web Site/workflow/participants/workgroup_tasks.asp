<%
  ...
  If (CLng(Session("uid")) = 0) Then
	...
	Sub Main()
		...
		gsWorkgroupTasks = oWorkgroup.ParticipantTasksTable(Session("sAppServer"), CLng(gnWorkgroupId))
...
<FORM name=frmSend action='./programs/save_workgroup_tasks.asp' method=post>
