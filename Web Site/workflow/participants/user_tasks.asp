<%
  ...
  If (CLng(Session("uid")) = 0) Then
	...
	Sub Main()
		...
		Set oRecordset   = oWorkgroup.Attributes(Session("sAppServer"), CLng(gnUserId))
		gsTitle					 = Left(oRecordset("participantName"), 40)
		Set oRecordset   = Nothing
		gsWorkgroupTasks = oWorkgroup.ParticipantTasksTable(Session("sAppServer"), CLng(gnUserId))
...
<FORM name=frmSend action='./programs/save_user_tasks.asp' method=post>
