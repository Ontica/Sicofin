<%
  ...
  Sub Main()
		...
		If (gnWorkgroupTasks > 0) Then
			...
			Next
			oParticipant.ParticipantTasks Session("sAppServer"), CLng(gnWorkgroupId), Split(sArray, ",")
		Else
			oParticipant.ParticipantTasks Session("sAppServer"), CLng(gnWorkgroupId), Null
		End If
