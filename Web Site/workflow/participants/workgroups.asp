  ...
  If (CLng(Session("uid")) = 0) Then
	...
	Sub GetExplorerInformation()
		...
		If (CLng(Request.Form.Count) <> 0) Then
			gsExplorerResultsBody = oExplorer.Body(Session("sAppServer"), 3, 0, _
...
<TABLE class=standardPageTable>
	<TR>
		<TD nowrap class=applicationTitle>
			<img align=absmiddle src='../images/participants.gif' height=25> Administración de grupos de trabajo
		</TD>
			...
			<TABLE class='fullScrollMenu'>
				<TR class="fullScrollMenuHeader">
					...
					<TD align=right nowrap>
					  <a href='' onclick='return(callEditor(1, 0));'>Agregar grupo de trabajo</a>
						&nbsp; | &nbsp;
						...
						&nbsp; | &nbsp;
						<A href='' onclick="return(showOptionsWindow(document.all.divSelectedItemsOptions));">Grupos de trabajo seleccionados</A>						
						&nbsp; &nbsp;
						<img align=absbottom src='../images/refresh_white.gif' onclick='document.all.frmSend.submit();' alt="Refrescar">						<img align=absmiddle src='../images/help_white.gif' onclick='notAvailable();' alt="Ayuda">
					</TD>
				</TR>
				<TR id=divSearchOptions style='display:none;'>
					<TD colspan=4 nowrap>
						<TABLE class="fullScrollMenu">
							...
							<TR>
								<TD nowrap><b>Por los usuarios que contienen:</b>&nbsp;</TD>
								<TD colspan=2 nowrap>
									<INPUT name=txtUsers style="width:230;height:20;" value='<%=gsGroups%>'>
										&nbsp; <INPUT class=cmdSubmit type=button name=cmdSend value="Usuarios ..." style='width:120;' onclick="doSubmit();">
								</TD>
							</TR>
							<TR>
