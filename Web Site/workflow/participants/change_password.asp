...
function canChangePassword(userName, password) {
	var obj;
	obj = RSExecute("../programs/scripts.asp", "CanChangePassword", userName, password);	
...
<FORM name=frmSend action="../programs/upd_password.asp" method="post" onsubmit="return checkValues();">
  <TR>
