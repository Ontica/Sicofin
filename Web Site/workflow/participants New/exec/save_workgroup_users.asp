<%
  ...
  Sub Main()
		...
		If (gnParticipantRelations > 0) Then
			...
			Next
			oParticipant.RelatedParticipants Application("sAppServer"), CLng(gnWorkgroupId), 1301, Split(sArray, ",")
		Else
			oParticipant.RelatedParticipants Application("sAppServer"), CLng(gnWorkgroupId), 1301, Null
		End If
