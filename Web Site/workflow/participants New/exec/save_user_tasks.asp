<%
  ...
  Sub Main()
		...
		If (gnWorkgroupTasks > 0) Then
			...
			Next
			oParticipant.ParticipantTasks Application("sAppServer"), CLng(gnUserId), Split(sArray, ",")
		Else
			oParticipant.ParticipantTasks Application("sAppServer"), CLng(gnUserId), Null
		End If
