<%
  ...
  Sub Main()
		...
		If (gnWorkgroupTasks > 0) Then
			...
			Next
			oParticipant.ParticipantTasks Application("sAppServer"), CLng(gnWorkgroupId), Split(sArray, ",")
		Else
			oParticipant.ParticipantTasks Application("sAppServer"), CLng(gnWorkgroupId), Null
		End If
