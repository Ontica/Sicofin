<%
  ...
  If (CLng(Session("uid")) = 0) Then
	...
	Sub Main()
		...
		gsWorkgroupUsers = oWorkgroup.RelatedParticipantsTable(Application("sAppServer"), CLng(gnWorkgroupId), 1301)
...
<FORM name=frmSend action='./exec/save_workgroup_users.asp' method=post>
