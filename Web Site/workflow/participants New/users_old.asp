...
<TABLE class=standardPageTable>
	<TR>
		<TD nowrap class=applicationTitle>
			<img align=absmiddle src='/empiria/images/users.gif' height=20> Administración de usuarios
		</TD>
		<TD colspan=3 align=right nowrap align=top>
			...
			<img align=absmiddle src='/empiria/images/task_white.gif' onclick='showOptionsWindow(document.all.divTasksOptions);' alt="Tareas">			<img align=absmiddle src='/empiria/images/help_white.gif' onclick='notAvailable();' alt="Ayuda">			<img align=absmiddle src='/empiria/images/invisible.gif'>
			<img align=absmiddle src='/empiria/images/close_white.gif' onclick="window.location.href = '<%=Session("main_page")%>';" alt="Cerrar y regresar a la página principal">		</TD>
	</TR>
