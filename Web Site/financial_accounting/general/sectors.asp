...
<TABLE align=center border=0 bgcolor=Khaki cellPadding=3 cellSpacing=3 width="70%">
	<TR>
		<TD nowrap><FONT face=Arial size=3 color=maroon><STRONG>Catálogo de sectores</STRONG></FONT></TD>
...
<% If Len(gsSectorsTable) <> 0 Then %>
	...
	<TR>
	  ...
	  <TD nowrap align=center><FONT color=maroon><b>Descripción</b></FONT></TD>	  
	</TR>
	<%=gsSectorsTable%>
	<TR>
