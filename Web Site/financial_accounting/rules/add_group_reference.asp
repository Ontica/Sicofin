<%
  ...
  If (CLng(Session("uid")) = 0) Then
	...
	Dim gnRuleGroupId, gnRuleDefId, gbSaveAsChild, gsCboRuleGroupPosition, gsCboReferencedGroups
	Dim gsCboOperators, gnParentRuleGroupId
	...
	Sub Main()
		...
		gsCboReferencedGroups = oRuleDef.CboRules(Session("sAppServer"), CLng(gnRuleDefId), 0, CLng(gnRuleGroupId))
...
<TR bgcolor=khaki height=25>
  <TD>
		<FONT face=Arial color=maroon><STRONG>Insertar referencia a otro grupo</STRONG></FONT>
  </TD>
...
<TR>
  ...
  <TD nowrap>
		<SELECT name=cboInsertAfterItems style="WIDTH: 100%">
		  <OPTION value=0>Insertar como primer elemento</OPTION>
...
<TR>
  ...
  <TD>
		...
		<INPUT name=txtSaveAsChild type=hidden value=True>
  </TD>
</TR>
<TR>
