<%
  Option Explicit
	...
	If CLng(Request.Form("txtRuleId")) = 0 Then
		...
		Call SaveItem(0)		
	Else
		gsReturnPage = "../edit_group_reference.asp?id=" & Request.Form("txtRuleId")
  ...
  Sub SaveItem(nRuleId)
		...
		If CLng(nRuleId) = 0 Then
			...
			oRecordset("tipo_grupo_cuenta")	  = 5
		End If
		...
		oRecordset("id_agrupador_origen")   = Request.Form("cboReferencedGroups")
