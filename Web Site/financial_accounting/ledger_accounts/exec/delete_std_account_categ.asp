<%
  ...
  Sub DeleteItem(nItemId)
		...
		oGralLedger.DeleteStandardAccountCategory Session("sAppServer"), CLng(nItemId)
...
<tr>
	<td bgColor="khaki"><b>El tipo de cuenta estándar fue eliminado satisfactoriamente.</b></td>
</tr>
<tr>
	<td>
		<br>
