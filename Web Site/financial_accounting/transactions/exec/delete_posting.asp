<%
  ...
  Sub DeleteItem(nPostingId)
		Dim oVoucherBS
		'***********************
		On Error Resume Next			
		Set oVoucherBS = Server.CreateObject("AOGLVoucher.CServer")
		oVoucherBS.DeletePosting Session("sAppServer"), CLng(nPostingId)
...
<tr>
	<td bgColor="khaki"><b>El movimiento fue eliminado satisfactoriamente.</b></td>
</tr>
<tr>
	<td>
		<br>
